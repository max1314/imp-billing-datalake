...
func init() {
	improbable_io_lib_perms_registry.RegisterPermissions("/improbable.infra.logging.LoggingService/LogStream",
		[]improbable_io_proto_improbable_ext_plugin_auth.Permission{},
	)
}

// The arguments for this v1 permission check.
type Permits_V1_PlatformDeploymentLogsWrite_Args struct {
	Deployment string
	Project    string
}

// Performs the delegated permission check described by delegation "PlatformDeploymentLogsWrite".
func Permits_V1_PlatformDeploymentLogsWrite(ctx context.Context, args Permits_V1_PlatformDeploymentLogsWrite_Args) error {
