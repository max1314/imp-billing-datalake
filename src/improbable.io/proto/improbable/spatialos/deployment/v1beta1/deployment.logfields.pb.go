...
func (this *Deployment) LogFields() map[string]string {
	...
	if !hasInner {
		...
		return map[string]string{
			"deployment_id":   fmt.Sprintf("%v", this.Id),
	...
	res["deployment_id"] = fmt.Sprintf("%v", this.Id)
...
func (this *SetDeploymentWorkerFlagsRequest) LogFields() map[string]string {
	...
	if !hasInner {
		// If no inner messages added any fields, avoid merging maps.
		return map[string]string{
			"deployment_id": fmt.Sprintf("%v", this.DeploymentId),
		}
	}
	// Merge all the field maps.
	res := map[string]string{}
	res["deployment_id"] = fmt.Sprintf("%v", this.DeploymentId)
	return res
}
...
func (this *RestartDeploymentRequest) LogFields() map[string]string {
	return map[string]string{}
}

func (this *RestartDeploymentRequest) ExtractRequestFields(dst map[string]interface{}) {
}

func (this *RestartDeploymentMetadata) LogFields() map[string]string {
	return map[string]string{}
}

func (this *RestartDeploymentMetadata) ExtractRequestFields(dst map[string]interface{}) {
}
