...
func init() {
	improbable_io_lib_perms_registry.RegisterPermissions("/improbable.spatialos.playerauth.v2.pri.PrivatePlayerAuthService/VerifyDevelopmentAuthenticationToken",
