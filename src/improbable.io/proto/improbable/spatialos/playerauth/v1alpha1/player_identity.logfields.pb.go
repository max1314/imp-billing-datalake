...
func (this *PlayerToken) LogFields() map[string]string {
	return map[string]string{}
}

func (this *PlayerToken) ExtractRequestFields(dst map[string]interface{}) {
}

func (this *CreatePlayerTokenRequest) LogFields() map[string]string {
...
func (this *CreatePlayerTokenRequest) ExtractRequestFields(dst map[string]interface{}) {
	// Handle being called on nil message.
	if this == nil {
		return
	}
...
func (this *CreatePlayerTokenResponse) LogFields() map[string]string {
	// Handle being called on nil message.
	if this == nil {
		return map[string]string{}
	}
...
func (this *CreatePlayerTokenResponse) ExtractRequestFields(dst map[string]interface{}) {
	// Handle being called on nil message.
	if this == nil {
		return
	}
