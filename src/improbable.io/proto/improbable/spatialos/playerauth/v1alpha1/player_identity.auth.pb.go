...
func init() {
	improbable_io_lib_perms_registry.RegisterPermissions("/improbable.spatialos.playerauth.v1alpha1.PlayerTokenService/CreatePlayerToken",
		[]improbable_io_proto_improbable_ext_plugin_auth.Permission{},
	)
}

// The arguments for this v1 permission check.
type Permits_V1_PlayerAuthV1PublicCreatePT_Args struct {
	Project string
}

// Performs the delegated permission check described by delegation "PlayerAuthV1PublicCreatePT".
func Permits_V1_PlayerAuthV1PublicCreatePT(ctx context.Context, args Permits_V1_PlayerAuthV1PublicCreatePT_Args) error {
