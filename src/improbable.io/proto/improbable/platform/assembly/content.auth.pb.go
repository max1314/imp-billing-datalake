...
func init() {
	improbable_io_lib_perms_registry.RegisterPermissions("/improbable.platform.assembly.AssemblyContentService/Get",
		[]improbable_io_proto_improbable_ext_plugin_auth.Permission{},
	)
	improbable_io_lib_perms_registry.RegisterPermissions("/improbable.platform.assembly.AssemblyContentService/BatchGet",
		[]improbable_io_proto_improbable_ext_plugin_auth.Permission{},
	)
	improbable_io_lib_perms_registry.RegisterPermissions("/improbable.platform.assembly.AssemblyContentService/GetArtifact",
		[]improbable_io_proto_improbable_ext_plugin_auth.Permission{},
	)
}
