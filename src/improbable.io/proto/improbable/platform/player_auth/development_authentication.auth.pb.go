...
func init() {
	improbable_io_lib_perms_registry.RegisterPermissions("/improbable.platform.player_auth.DevelopmentAuthenticationService/CreateDevelopmentPlayerIdentityToken",
